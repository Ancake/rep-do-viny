import {criarGrafico, getCSS } from "./coomon.js"
...
async function redesSociaisFavoritasMinhaEscola() {
    ...
    const valores = Object.values(contagemResdesSociais)
    ...
    const layout = {
        ...
        paper_bgcolor: getCSS('--font'),
        height: 700,
        title: {
            text: 'O Celta brabo capotou do morro do anhangava',
            x: 0,
            font: {
